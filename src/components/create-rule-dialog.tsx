    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[700px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>通过表单或JSON创建新的书源规则</DialogDescription>
        </DialogHeader>
        ...
        <Tabs value={mode} onValueChange={(v) => setMode(v as "form" | "json")}>
          ...
          <TabsContent value="form" className="space-y-4 py-4">
            ...
            <div className="space-y-3 border-b pb-4">
              ...
              <div className="grid gap-3">
                <div>
                  <Label htmlFor="search-url" className="text-xs">
                    搜索URL *
                  </Label>
                  <Input
                    id="search-url"
                    ...
                    onChange={(e) =>
                      handleFormChange("search.url", e.target.value)
                    }
                    className="mt-1"
                  />
                </div>
                <div>
                  <Label htmlFor="search-method" className="text-xs">
                    请求方法 *
                  </Label>
                  <select
                    id="search-method"
                    ...
                    onChange={(e) =>
                      handleFormChange("search.method", e.target.value)
                    }
                ...
                <div>
                  <Label htmlFor="search-data" className="text-xs">
                    请求数据
                  </Label>
                  <Input
                    id="search-data"
                    ...
                    onChange={(e) =>
                      handleFormChange("search.data", e.target.value)
                    }
                    className="mt-1"
                  />
                </div>
                <div>
                  <Label htmlFor="search-result" className="text-xs">
                    结果选择器 *
                  </Label>
                  <Input
                    id="search-result"
                    ...
                    onChange={(e) =>
                      handleFormChange("search.result", e.target.value)
                    }
                    className="mt-1"
                  />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <Label htmlFor="search-bookname" className="text-xs">
                      书名选择器 *
                    </Label>
                    <Input
                      id="search-bookname"
                      ...
                      onChange={(e) =>
                        handleFormChange("search.bookName", e.target.value)
                      }
                      className="mt-1"
                    />
                  </div>
                  <div>
                    <Label htmlFor="search-author" className="text-xs">
                      作者选择器 *
                    </Label>
                    <Input
                      id="search-author"
                      ...
                      onChange={(e) =>
                        handleFormChange("search.author", e.target.value)
                      }
                      className="mt-1"
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <Label htmlFor="search-latest" className="text-xs">
                      最新章节选择器
                    </Label>
                    <Input
                      id="search-latest"
                      ...
                      onChange={(e) =>
                        handleFormChange("search.latestChapter", e.target.value)
                      }
                      className="mt-1"
                    />
                  </div>
                  <div>
                    <Label htmlFor="search-update" className="text-xs">
                      更新时间选择器
                    </Label>
                    <Input
                      id="search-update"
            ...
            <div className="space-y-3 border-b pb-4">
              ...
              <div className="grid gap-3">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <Label htmlFor="book-name" className="text-xs">
                      书名选择器 *
                    </Label>
                    <Input
                      id="book-name"
                      ...
                      onChange={(e) =>
                        handleFormChange("book.bookName", e.target.value)
                      }
                      className="mt-1"
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) =>
                        handleFormChange("book.author", e.target.value)
                      }
                      className="mt-1"
                    />
                  </div>
                ...
                <div>
                  <Label htmlFor="book-intro" className="text-xs">
                    简介选择器 *
                  </Label>
                  <Input
                    id="book-intro"
                    ...
                    onChange={(e) =>
                      handleFormChange("book.intro", e.target.value)
                    }
                    className="mt-1"
                  />
                </div>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <Label htmlFor="book-category" className="text-xs">
                      分类选择器
                    </Label>
                    <Input
                      id="book-category"
                      ...
                      onChange={(e) =>
                        handleFormChange("book.category", e.target.value)
                      }
                      className="mt-1"
                    />
                  </div>
                  <div>
                    <Label htmlFor="book-cover" className="text-xs">
                      封面选择器
                    </Label>
                    <Input
                      id="book-cover"
                      ...
                      onChange={(e) =>
                        handleFormChange("book.coverUrl", e.target.value)
                      }
                      className="mt-1"
                    />
                  </div>
            ...
            <div className="space-y-3 border-b pb-4">
              ...
              <div className="grid gap-3">
                <div>
                  <Label htmlFor="toc-url" className="text-xs">
                    目录URL
                  </Label>
                  <Input
                    id="toc-url"
                    ...
                    onChange={(e) =>
                      handleFormChange("toc.url", e.target.value)
                    }
                    className="mt-1"
                  />
                </div>
                <div>
                  <Label htmlFor="toc-item" className="text-xs">
                    目录项选择器 *
                  </Label>
                  <Input
                    id="toc-item"
                    ...
                    onChange={(e) =>
                      handleFormChange("toc.item", e.target.value)
                    }
                    className="mt-1"
                  />
                </div>
              ...
              <div className="grid gap-3">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      handleFormChange("chapter.title", e.target.value)
                    }
                    className="mt-1"
                  />
                </div>
                <div>
                  <Label htmlFor="chapter-content" className="text-xs">
                    内容选择器 *
                  </Label>
                  <Input
                    id="chapter-content"
                    ...
                    onChange={(e) =>
                      handleFormChange("chapter.content", e.target.value)
                    }
                    className="mt-1"
                  />
                </div>
                <div>
                  <Label htmlFor="chapter-filter" className="text-xs">
                    过滤文本（正则）
                  </Label>
                  <Textarea
                    id="chapter-filter"
                    ...
                    onChange={(e) =>
                      handleFormChange("chapter.filterTxt", e.target.value)
                    }
                    className="mt-1 h-20"
                  />
                </div>
                <div>
                  <Label htmlFor="chapter-tag" className="text-xs">
                    过滤标签
                  </Label>
                  <Input
                    id="chapter-tag"
                    ...
                    onChange={(e) =>
                      handleFormChange("chapter.filterTag", e.target.value)
                    }
                    className="mt-1"
                  />
                </div>
          ...
          <TabsContent value="json" className="space-y-4 py-4">
            <div className="grid gap-2">
              <Label htmlFor="json-content" className="text-xs">
                JSON 内容
              </Label>
              <Textarea
                id="json-content"
