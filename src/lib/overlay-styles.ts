...
export const overlayMaxHeight = "max-h-[var(--radix-dropdown-menu-content-available-height)]"
...
export const overlayItemHover = "data-[highlighted]:bg-accent data-[highlighted]:text-accent-foreground"
...
export const overlaySubTrigger =
  `${overlayItemBase} ${overlayItemHover} ${overlayItemDisabled} ${overlayItemTransition} data-[state=open]:bg-accent`
